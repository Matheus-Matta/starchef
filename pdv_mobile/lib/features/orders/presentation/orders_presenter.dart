...
class OrdersPresenter extends ChangeNotifier {
  ...
  /// De onde vieram os pedidos na tela: do backend ou da cópia local.
  ...
  /// Pedidos novos ainda não confirmados pelo backend (fila offline) — sem
  /// isto, sair da tela de detalhe antes de sincronizar faria o pedido
  /// "sumir" até a rede voltar. `BackendGateway.pending` já sobrevive a fechar
