...
///
/// Aparece quando o backend não respondeu e a leitura saiu da cópia
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: AppNotice(
        ...
        message: at == null
            ? 'backend fora do ar. Mostrando os últimos dados '
                  'recebidos.'
            : 'backend fora do ar. Dados de ${_clock(at)} — pode ter '
                  'mudado.',
