...
// `latest-desktop.json`, e NÃO o `latest.json` do PDV 1.8.x.
//
// As duas linhagens convivem: o PDV antigo, que opera offline, continua em
// produção. Um manifesto só faria o app antigo enxergar a 3.0.0 como
// atualização, baixar um ZIP cujo executável tem outro nome e recusá-lo a cada
// verificação — ou, pior, aplicá-lo e trocar um PDV que vende sem internet por
// um que não vende.
