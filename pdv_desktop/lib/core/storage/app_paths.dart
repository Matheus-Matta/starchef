...
///
/// A fila da impressora e a sessão do operador precisam sobreviver a
/// reinicializações do computador, então o destino nunca pode ser um diretório
/// temporário quando existir um lugar estável. No Windows usamos `%LOCALAPPDATA%`; no Linux/macOS seguimos o
...
abstract final class AppPaths {
  ...
  static String _baseDirectory() {
    ...
    // `/tmp` é justamente o pior lugar para guardar credenciais, fila da
  ...
  /// [_baseDirectory]) e perdia a sessão do operador a cada
