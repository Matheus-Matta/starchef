...
class _TerminalPreferencesDialogState extends State<TerminalPreferencesDialog> {
  ...
  late final TextEditingController terminalName = TextEditingController(
    text: widget.preferences.terminalName,
  );

  @override
  void dispose() {
    terminalName.dispose();
    super.dispose();
  }
    ...
    return AppDialog(
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            _section('Este terminal', scheme),
            TextField(
              controller: terminalName,
              textCapitalization: TextCapitalization.words,
              decoration: const InputDecoration(
                labelText: 'Nome deste terminal',
                hintText: 'Balcão 01',
            ...
            Text(
              'É o nome que aparece nos relatórios e na mensagem que avisa que '
              'o caixa está aberto em outra máquina. Sem nome, o operador lê '
              'só o identificador da instalação — e não descobre de qual '
              'computador se trata.',
            ...
            _readOnlyRow(
              ...
              label: 'Identificador desta instalação',
              value: widget.preferences.terminalInstallationId,
              scheme: scheme,
            ),
            _readOnlyRow(
              icon: Icons.usb,
