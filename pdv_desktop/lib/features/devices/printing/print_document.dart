...
import 'print_job_type.dart';

/// O tipo do trabalho acompanha o documento em todo lugar que ele vai:
/// quem importa um importa o outro, e separar os dois imports só criaria
/// uma linha a mais em cada arquivo que imprime.
export 'print_job_type.dart';
