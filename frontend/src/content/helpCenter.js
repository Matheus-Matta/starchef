    ...
    articles: [
      {
        ...
        purpose: "O produto concentra os dados comerciais, a disponibilidade, o setor de producao, a minutagem, o codigo de scanner e o perfil fiscal. Preparo e consumo ficam na ficha tecnica.",
        steps: [
      ...
      },
      {
        ...
        title: "Insumos",
        icon: "flask",
        summary: "Liste os insumos usados nas fichas técnicas e no controle de estoque.",
        purpose: "Insumos formam a base das fichas tecnicas. Com Logistica habilitada, ajudam a calcular consumo e estoque minimo.",
        steps: [
          "Cadastre o nome e a unidade de medida usada na cozinha.",
          "Informe estoque minimo quando houver controle logistico.",
          "Associe o insumo às fichas técnicas com a quantidade de consumo.",
      ...
      },
      {
        ...
        icon: "salad",
        summary: "Defina o preparo e relacione o consumo de insumos aos produtos.",
        purpose: "A ficha registra rendimento, modo de preparo e insumos de um produto. Ela calcula custo e pode dar baixa automatica no estoque conforme as vendas.",
        steps: [
          "Escolha o produto final.",
          "Informe o rendimento real da preparacao.",
          "Descreva o modo de preparo na ordem de execucao.",
          "Adicione cada insumo, sua quantidade e unidade.",
        ...
        example: "A ficha do X-Salada descreve a montagem e usa 1 pao, 1 hamburguer, 1 fatia de queijo e alface. Ao vender uma unidade, o sistema calcula o custo e desconta as quantidades do estoque.",
        tips: ["Uma ficha incorreta afeta preparo, custo e estoque; valide primeiro em poucos produtos."],
      },
    ],
  },
  {
