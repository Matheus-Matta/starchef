...
export const resources = [
  ...
  // ── Cardapio ───────────────────────────────────────────────────────
  {
    ...
    defaultParams: {
      exclude_item_types: "EQUIPMENT,FIXED_ASSET,REUSABLE_MATERIAL,CONSUMABLE,PACKAGING,INGREDIENT",
    },
    columns: [
      ...
      { key: "current_stock_display", label: "Estoque", align: "right" },
      { key: "sector_name", label: "Setor" },
      { key: "is_active", label: "Ativo", type: "boolean" },
    ],
    formFields: [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "current_stock_display", label: "Saldo em Estoque", align: "right" },
  ...
  // ── Estoque ────────────────────────────────────────────────────────
  {
    ...
    columns: [
      { key: "item_name", label: "Item / Insumo" },
      ...
      { key: "stock_unit", label: "Unid.", align: "center" },
  ...
  // ── Impressao ──────────────────────────────────────────────────────
  {
    ...
    columns: [
      ...
      { key: "cash_drawer_enabled", label: "Gaveta", type: "boolean" },
      { key: "is_active", label: "Ativa", type: "boolean" },
    ],
    formFields: [
      { name: "name", label: "Nome", type: "text", maxlength: 120, required: true },
      ...
      { name: "cash_drawer_enabled", label: "Abrir gaveta de dinheiro", type: "boolean", default: false, hint: "Exige driver ESC/POS. A gaveta abre junto com a venda em dinheiro e com os comprovantes de caixa." },
      { name: "cash_drawer_pin", label: "Saida da gaveta", type: "dropdown", options: PRINTER_DRAWER_PIN_OPTIONS, default: 2, hint: "Saida acionada no conector RJ12 da impressora." },
      { name: "cash_drawer_on_ms", label: "Pulso ligado (ms)", type: "number", default: 100, min: 1, max: 510, hint: "Comece por 100 ms e so aumente se a gaveta nao destravar." },
      { name: "cash_drawer_off_ms", label: "Intervalo desligado (ms)", type: "number", default: 400, min: 1, max: 510, hint: "Precisa ser maior ou igual ao tempo ligado." },
  ...
  {
    name: "reutilizaveis",
    title: "Vasilhames & Reutilizáveis",
    endpoint: "/assets/reusables/",
    module: "logistica",
    pro: {
      pageSize: 20,
      description: "Controle agrupado de vasilhames retornáveis, engradados, garrafas KS, copos, canecas e louças com controle de saldo acumulado (entradas menos perdas/quebras) e alertas de estoque mínimo.",
    },
    columns: [
      { key: "internal_code", label: "Código", align: "center" },
      { key: "name", label: "Material / Vasilhame" },
      { key: "current_stock_display", label: "Saldo Atual", align: "right" },
      { key: "minimum_stock", label: "Estoque Mín.", align: "right" },
      { key: "stock_status", label: "Alerta Mínimo", align: "center" },
      { key: "total_entries", label: "Entradas (+)", align: "right" },
      { key: "total_losses", label: "Quebras (-)", align: "right" },
      { key: "location_name", label: "Local Atual" },
    ],
    formFields: [
      { name: "name", label: "Descrição do vasilhame / material", type: "text", required: true, full: true, section: "Identificação" },
      { name: "internal_code", label: "Código interno", type: "text", section: "Identificação" },
      { name: "brand", label: "Marca / Fabricante", type: "text", section: "Identificação" },
      { name: "model", label: "Modelo / Especificação", type: "text", section: "Identificação" },
      { name: "stock_unit", label: "Unidade de estoque", type: "text", default: "UN", section: "Identificação" },
      { name: "minimum_stock", label: "Estoque mínimo de alerta", type: "decimal", section: "Estoque e Alertas", hint: "Quantidade mínima desejada em circulação. Emite alerta se o saldo for menor." },
      { name: "estimated_cost", label: "Custo unitário de reposição (R$)", type: "decimal", section: "Valores" },
    ],
  },
  {
    name: "lotes-estoque",
    title: "Lotes e Validades (FEFO)",
    endpoint: "/stock/inventory-lots/",
    module: "logistica",
    pro: {
      pageSize: 15,
