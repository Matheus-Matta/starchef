...
const icons = {
  ...
  "hash": "pi-hashtag",
  "image": "pi-image",
  "layout-grid": "pi-th-large",
  "layout-template": "pi-sitemap",
  "list": "pi-list",
...
const iconClass = computed(() => `pi ${icons[props.name] || "pi-circle"}`);
</script>
