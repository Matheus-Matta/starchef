  ...
  <div class="help-center">
    ...
    <main class="help-layout">
      ...
      <article v-else-if="activeArticle" :id="activeArticle.id" class="help-article">
        ...
        <section v-if="activeArticle.example" class="help-article__block help-example">
          <h2>Exemplo prático</h2>
          <p>{{ activeArticle.example }}</p>
        </section>
...
.help-brand strong { color: #F97316; }
...
.help-login { display: inline-flex; align-items: center; color: #fff; background: #EA580C; }
.help-login:hover { background: #C2410C; }

.help-hero {
  padding: 62px 24px 72px;
  background:
    radial-gradient(circle at 20% 0%, rgba(249, 115, 22, .2), transparent 35%),
    radial-gradient(circle at 82% 15%, rgba(255, 255, 255, .09), transparent 24%),
    linear-gradient(135deg, #7C2D12 0%, #9A3412 55%, #EA580C 100%);
  color: #fff;
}

.help-hero__content { width: min(760px, 100%); margin: 0 auto; text-align: center; }
.help-eyebrow { display: block; color: #F97316; font-size: 11px; font-weight: 850; letter-spacing: .14em; }
.help-hero .help-eyebrow { color: #FDBA74; }
.help-hero h1 { margin: 9px 0 12px; font-size: clamp(32px, 5vw, 48px); line-height: 1.05; letter-spacing: -.04em; }
.help-hero p { margin: 0 auto; max-width: 650px; color: #FFEDD5; font-size: 16px; line-height: 1.6; }
...
.help-hero__meta { display: flex; justify-content: center; gap: 22px; margin-top: 18px; color: #FED7AA; font-size: 12px; font-weight: 650; }
...
.help-nav__section-button--active { background: #FFEDD5; color: #EA580C; }
.help-nav__section-button--active small { background: #fff; color: #EA580C; }
...
.help-nav__articles .help-nav__article--active { color: #EA580C; font-weight: 800; }
...
.help-breadcrumb button { padding: 0; border: 0; background: none; color: #EA580C; cursor: pointer; font: inherit; font-weight: 750; }
...
.help-example > p { padding: 16px 18px; border: 1px solid #FED7AA; border-radius: 12px; background: #FFF7ED; color: #7C2D12; }
...
.help-steps li > span { width: 27px; height: 27px; display: inline-flex; align-items: center; justify-content: center; border-radius: 8px; background: #FFEDD5; color: #EA580C; font-size: 12px; font-weight: 850; }
...
.help-data-list :deep(i) { margin-top: 3px; color: #F97316; }
...
.help-tip { display: flex; gap: 12px; margin-top: 34px; padding: 18px; border-radius: 13px; background: #FFF7ED; color: #9A3412; }
...
.help-article__footer a { flex-shrink: 0; padding: 11px 15px; border-radius: 9px; background: #EA580C; color: #fff; font-size: 12px; font-weight: 800; text-decoration: none; }
...
.help-article__pagination button:hover:not(:disabled) { border-color: #FB923C; color: #EA580C; }
...
.help-empty button { border: 0; background: transparent; color: #EA580C; cursor: pointer; font: 800 12px/1 var(--font-sans); }
...
.help-result-card:hover { transform: translateY(-1px); border-color: #FB923C; box-shadow: 0 8px 24px rgba(234, 88, 12, .08); }
...
.help-result-card__copy small { color: #F97316; font-size: 10px; font-weight: 850; letter-spacing: .08em; text-transform: uppercase; }
