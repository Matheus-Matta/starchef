    ...
    <div v-else-if="isView && record && !formFields" class="rpage__view">
      ...
      <section class="detail-section">
        ...
        <div class="detail-fields">
          <ResourceDetailField v-for="field in detailFields" :key="field.key" :field="field" :record="record" />
        </div>
      </section>
...
import ResourceDetailField from "../components/data/ResourceDetailField.vue";
